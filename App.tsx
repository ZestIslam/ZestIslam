      ...
      <aside className="hidden lg:flex flex-col w-72 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 fixed h-full z-30">
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-800 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
                ...
                <button onClick={() => setView(AppView.CONTACT)} className="flex items-center justify-center p-3 rounded-xl bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300"><Settings className="w-4 h-4" /></button>
            </div>
        </div>
      </aside>
